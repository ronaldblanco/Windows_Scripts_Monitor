...
Set colProcessList = objWMIService.ExecQuery("Select * from Win32_Process where Name='MBA3 v17.2 Client.exe'")
' where Name='MBA3 v11 Client.exe'

Const ForReading=1
Const ForWriting=2
Set objFSO = CreateObject("Scripting.FileSystemObject")
'folder = "\\newmba\Backup_Servers\00temp\SQL_STATE_share\"
filePath = folder & "PROCESSSTATUSCLIENT.asp"

Set myTemp= objFSO.OpenTextFile(filePath & ".tmp1", ForWriting, True)

myTemp.WriteLine "MBA_EMAIL|"
...
'' SIG '' AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFPArxSdfYDZC
'' SIG '' VKHcKkKw3GQw9X0xoIICGzCCAhcwggGAoAMCAQICEIig
...
'' SIG '' BAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUHdRyXwZN7SSP
'' SIG '' mdDz9Fv8Nm+DvPQwDQYJKoZIhvcNAQEBBQAEgYAZfGvx
'' SIG '' LLQXx6p9kOMMnFDW1K46CRuOAnU1OPpAsjCPrp8rFuZA
'' SIG '' FPehbZJBG1abdhZrqvuQvsrQ8o0kZd/o3RnKy+zedLW5
'' SIG '' bpTqrOYzmpjO0tiOJzbLQcPgrYEliDcYpov5G8J1T/wW
'' SIG '' KRZJ6sA/bk19FAfFCsP6WNVEzxgRigDO+Q==
